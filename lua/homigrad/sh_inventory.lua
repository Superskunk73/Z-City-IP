...
if CLIENT then
	...
	OpenInv = function(ent)
		...
		function plyMenu:Think()
			...
			if ent:IsPlayer() and not IsValid(ent.FakeRagdoll) and not ent:GetNWBool("Surrendering") == true and not ent:GetNWBool("Kneeling") == true then self:Remove() return end
